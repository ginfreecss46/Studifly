...
import { TextInput, StyleSheet, Alert, ScrollView, View, useColorScheme as useRNColorScheme, TouchableOpacity, Platform, Pressable } from 'react-native';
...
export default function AddCourseScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Succès', 'La matière et son emploi du temps ont été ajoutés.');
      router.back();
        ...
        {schedules.map((schedule, index) => (
          <View key={index} style={styles.scheduleContainer}>
            ...
            <Picker
              ...
              onValueChange={(itemValue) => handleScheduleChange(index, 'day', itemValue)}
              style={styles.picker}
